        ...
        <div class="flex-grid">
            ...
            $services = [
                [
                    ...
                    'url'      => synergia_indexed_url( 'strategie-excellence-operationnelle' ),
                ],
                [
                    ...
                    'url'      => synergia_indexed_url( 'transactions-due-diligence' ),
                ],
                [
                    ...
                    'url'      => synergia_indexed_url( 'corporate-finance-modelisation' ),
                ],
                [
                    ...
                    'url'      => synergia_indexed_url( 'cfo-advisory-transformation' ),
                ],
                [
                    ...
                    'url'      => synergia_indexed_url( 'financement-levee-fonds' ),
                ],
                [
                    ...
                    'url'      => synergia_indexed_url( 'subventions-financements-publics' ),
                ],
                [
                    ...
                    'url'      => synergia_indexed_url( 'academie-formation' ),
                ],
            ];
